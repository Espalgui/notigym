...
const CHANGELOG: ChangelogEntry[] = [
  {
    version: "2.4.0",
    date: "2026-04-01",
    title_fr: "NotiGym v2.4 — Grosse mise à jour !",
    title_en: "NotiGym v2.4 — Big update!",
    changes_fr: [
      "Dashboard enrichi : streak, prochaine séance planifiée, macros du jour en temps réel",
      "Alerte planning : notification si aucune séance n'est planifiée",
      "Eau personnalisée : entrez un montant custom sur le dashboard",
      "Repas types : sauvegardez vos repas et réappliquez-les en 1 clic",
      "Bouton « Repas type » en haut de la page Nutrition",
      "Dupliquer un programme : copiez un programme existant en un clic",
      "Lancer un template : démarrez une séance directement depuis les recommandés",
      "Onglet Recommandés séparé dans les entraînements",
      "Filtres historique : filtrez par dates, groupe musculaire ou exercice",
      "Export CSV : téléchargez tout votre historique de séances",
      "Recherche globale : trouvez exercices, recettes et utilisateurs depuis la navbar (Cmd+K)",
      "Comparaison stats : comparez deux mois côte à côte (séances, volume, PRs...)",
      "Onboarding : visite guidée en 7 étapes pour les nouveaux utilisateurs",
      "Assistant FAQ : posez vos questions depuis le bouton Aide dans la sidebar",
      "Loading skeletons : animations de chargement élégantes",
      "Pagination historique : chargement progressif des séances",
    ],
    changes_en: [
      "Enriched Dashboard: streak, next planned session, real-time daily macros",
      "Planning alert: notification if no sessions are planned",
      "Custom water: enter any amount on the dashboard",
      "Meal templates: save meals and reapply them in 1 click",
      "\"Meal template\" button at the top of the Nutrition page",
      "Duplicate program: copy an existing program in one click",
      "Launch template: start a session directly from recommended templates",
      "Separate Recommended tab in workouts",
      "History filters: filter by dates, muscle group or exercise",
      "CSV export: download your entire session history",
      "Global search: find exercises, recipes and users from the navbar (Cmd+K)",
      "Stats comparison: compare two months side by side (sessions, volume, PRs...)",
      "Onboarding: 7-step guided tour for new users",
      "FAQ assistant: ask questions from the Help button in the sidebar",
      "Loading skeletons: elegant loading animations",
      "History pagination: progressive session loading",
    ],
  },
  {
    version: "2.3.0",
